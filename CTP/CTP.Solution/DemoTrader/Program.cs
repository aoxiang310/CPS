...
namespace DemoTrader
{
    ...
    class testTraderApi
    {
        ...
        string FRONT_ADDR = "tcp://180.168.146.187:10000";  // 前置地址
        string BROKER_ID = "9999";                       // 经纪公司代码
        string INVESTOR_ID = "110479";                   // 投资者代码
        string PASSWORD = "8447357fax#";                      // 用户密码, 888888账户的密码被人改了，没法用了
        string INSTRUMENT_ID = "ag1806";
